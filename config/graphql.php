...
return [
    ...
    'types' => [
        ...
        'Texture' => GraphQL\Types\TextureType::class,
        'Player' => GraphQL\Types\PlayerType::class,
        'ClosetItem' => GraphQL\Types\ClosetItemType::class,
        'PermissionEnum' => GraphQL\Enums\PermissionEnum::class,
    ],
